...
var Core = require('@moralisweb3/common-core');
...
var OperationRequestBuilder = /** @class */ (function () {
    ...
    OperationRequestBuilder.prototype.prepareHeaders = function () {
        ...
        var product = this.core.config.get(Core.CoreConfig.product);
        if (!apiKey) {
            throw new Core.MoralisApiError({
                code: Core.ApiErrorCode.API_KEY_NOT_SET,
...
var OperationResolver = /** @class */ (function () {
    function OperationResolver(operation, baseUrl, core) {
        ...
        this.core = core;
        this.requestValidator = new Core.OperationRequestValidator(this.operation);
        this.requestBuilder = new OperationRequestBuilder(this.operation, this.core);
        this.requestController = Core.RequestController.create(this.core);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Core.ResponseAdapter(jsonResponse, function () {
...
function isNotFoundError(e) {
    var _a;
    if (Core.isMoralisError(e)) {
        if (((_a = e.details) === null || _a === void 0 ? void 0 : _a.status) === 404) {
            return true;
        }
        if (e.code === Core.ApiErrorCode.NOT_FOUND) {
            return true;
        }
    }
    return false;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!result.raw || (typeof result.raw === 'object' && Object.keys(result.raw).length === 0)) {
                            throw new Core.MoralisApiError({
                                code: Core.ApiErrorCode.NOT_FOUND,
        ...
        this.fetch = function (request) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        jsonResponse = _b.sent();
                        pagination = Core.PaginationReader.read(jsonResponse);
                        nextRequest = Core.NextPaginatedRequestResolver.resolve(this.operation.firstPageIndex, request, pagination);
                        return [2 /*return*/, new Core.PaginatedResponseAdapter(pagination, jsonResponse, function () { return _this.operation.deserializeResponse(jsonResponse, request, _this.core); }, nextRequest ? function () { return _this.fetch(nextRequest); } : undefined)];
                }
            });
        }); };
...
var ApiUtils = /** @class */ (function (_super) {
    ...
    ApiUtils.create = function (core) {
        return new ApiUtils(core !== null && core !== void 0 ? core : Core.CoreProvider.getDefault());
    };
