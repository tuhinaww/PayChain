...
var makeSolRequestMessage = function (core, _a) {
    ...
    return new OperationResolver(requestChallengeSolanaOperation, BASE_URL, core).fetch(__assign({ network: SolNetwork.create(solNetwork).network, address: SolAddress.create(address).toString() }, options));
};
var makeAptosRequestMessage = function (core, _a) {
    ...
    return new OperationResolver(requestChallengeAptosOperation, BASE_URL, core).fetch(__assign({ chainId: AptosNetwork.create(chain).network, address: AptosAddress.create(address).toString() }, options));
};
