...
var AptosPendingTransactionPayload = /** @class */ (function () {
    ...
    AptosPendingTransactionPayload.fromJSON = function (json) {
        ...
        var type = json.type;
        throw new Error("Cannot resolve union for AptosPendingTransactionPayload (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosMultiAgentSignatureRequestSecondarySigners = /** @class */ (function () {
    ...
    AptosMultiAgentSignatureRequestSecondarySigners.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosMultiAgentSignatureRequestSecondarySigners (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosPendingTransactionSignature = /** @class */ (function () {
    ...
    AptosPendingTransactionSignature.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosPendingTransactionSignature (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosUserTransactionChangesItem = /** @class */ (function () {
    ...
    AptosUserTransactionChangesItem.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosUserTransactionChangesItem (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosUserTransactionPayload = /** @class */ (function () {
    ...
    AptosUserTransactionPayload.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosUserTransactionPayload (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosUserTransactionSignature = /** @class */ (function () {
    ...
    AptosUserTransactionSignature.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosUserTransactionSignature (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosUserTransaction = /** @class */ (function () {
    ...
    AptosUserTransaction.prototype.toJSON = function () {
        return {
            ...
            changes: this.changes.map(function (item) { return item.toJSON(); }),
            sender: this.sender.toJSON(),
            sequence_number: this.sequenceNumber,
            max_gas_amount: this.maxGasAmount,
            gas_unit_price: this.gasUnitPrice,
...
var AptosGenesisTransactionChangesItem = /** @class */ (function () {
    ...
    AptosGenesisTransactionChangesItem.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosGenesisTransactionChangesItem (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosWriteSetPayloadWriteSet = /** @class */ (function () {
    ...
    AptosWriteSetPayloadWriteSet.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosWriteSetPayloadWriteSet (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosBlockMetadataTransactionChangesItem = /** @class */ (function () {
    ...
    AptosBlockMetadataTransactionChangesItem.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosBlockMetadataTransactionChangesItem (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosStateCheckpointTransactionChangesItem = /** @class */ (function () {
    ...
    AptosStateCheckpointTransactionChangesItem.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosStateCheckpointTransactionChangesItem (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosGetTransactionsItem = /** @class */ (function () {
    ...
    AptosGetTransactionsItem.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosGetTransactionsItem (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosSubmitTransactionRequestPayload = /** @class */ (function () {
    ...
    AptosSubmitTransactionRequestPayload.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosSubmitTransactionRequestPayload (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosSubmitTransactionRequestSignature = /** @class */ (function () {
    ...
    AptosSubmitTransactionRequestSignature.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosSubmitTransactionRequestSignature (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosGetTransactionByHash = /** @class */ (function () {
    ...
    AptosGetTransactionByHash.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosGetTransactionByHash (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosGetTransactionByVersion = /** @class */ (function () {
    ...
    AptosGetTransactionByVersion.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosGetTransactionByVersion (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosGetAccountTransactionsItem = /** @class */ (function () {
    ...
    AptosGetAccountTransactionsItem.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosGetAccountTransactionsItem (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosSimulateTransaction = /** @class */ (function () {
    ...
    AptosSimulateTransaction.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosSimulateTransaction (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosEncodeSubmissionRequestPayload = /** @class */ (function () {
    ...
    AptosEncodeSubmissionRequestPayload.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosEncodeSubmissionRequestPayload (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosBlockTransactionsItem = /** @class */ (function () {
    ...
    AptosBlockTransactionsItem.fromJSON = function (json) {
        ...
        var keys = Object.keys(json).join(', ');
        var type = json.type;
        throw new Error("Cannot resolve union for AptosBlockTransactionsItem (keys: ".concat(keys, ", type: ").concat(type, ")"));
    };
...
var AptosBlock = /** @class */ (function () {
    ...
    AptosBlock.prototype.toJSON = function () {
        return {
            ...
            transactions: this.transactions ? this.transactions.map(function (item) { return item.toJSON(); }) : undefined,
        };
    };
    return AptosBlock;
}());
