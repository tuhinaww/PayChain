...
function deserializeResponse$a(_a) {
    ...
    return __assign(__assign({}, jsonResponse), { chain: AptosNetwork.create(chainId), address: AptosAddress.create(jsonResponse.address), expirationTime: maybe(jsonResponse.expirationTime, function (value) { return new Date(value); }), notBefore: maybe(jsonResponse.notBefore, function (value) { return new Date(value); }) });
}
