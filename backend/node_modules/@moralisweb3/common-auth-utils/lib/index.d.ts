...
declare function deserializeResponse$a({ chainId, ...jsonResponse }: VerifyChallengeAptosJSONResponse): {
    chain: AptosNetwork;
...
interface RequestChallengeAptosRequest extends Camelize<Omit<RequestParams$9, 'address' | 'chainId' | 'expirationTime' | 'notBefore'>> {
...
interface RemoveBindRequest extends Camelize<Omit<RequestParams$5, 'address' | 'publicKey'>> {
    address: EvmAddressish;
    publicKey?: string;
}
