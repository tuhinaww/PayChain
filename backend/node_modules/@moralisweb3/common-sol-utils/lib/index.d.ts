...
import _moralisweb3_common_core__default, { MoralisData, MoralisDataFormatted, BigNumberish, BigNumber, Module, Camelize, ResponseAdapter, Operation, Core, Config, ConfigKey } from '@moralisweb3/common-core';
...
declare class CommonSolUtils extends Module {
    ...
    static create(core?: _moralisweb3_common_core__default): CommonSolUtils;
    private constructor();
    setup(): void;
    start(): void;
...
declare class SolNetworkResolver {
    static resolve(network: SolNetworkish | undefined, core: _moralisweb3_common_core__default): SolNetworkName;
}
