...
var EvmStream = /** @class */ (function () {
    ...
    EvmStream.parse = function (data, core) {
        var _a, _b, _c, _d;
        return __assign(__assign({}, data), { chains: data.chainIds.map(function (chainId) { return commonEvmUtils.EvmChain.create(chainId, core); }), topic0: commonCore.maybe(data.topic0), allAddresses: (_a = data.allAddresses) !== null && _a !== void 0 ? _a : false, includeContractLogs: (_b = data.includeContractLogs) !== null && _b !== void 0 ? _b : false, includeInternalTxs: (_c = data.includeInternalTxs) !== null && _c !== void 0 ? _c : false, includeNativeTxs: (_d = data.includeNativeTxs) !== null && _d !== void 0 ? _d : false, advancedOptions: commonCore.maybe(data.advancedOptions), abi: commonCore.maybe(data.abi), triggers: commonCore.maybe(data.triggers, function (triggers) { return triggers.map(function (trigger) { return StreamTrigger.create(trigger, core); }); }), getNativeBalances: commonCore.maybe(data.getNativeBalances) });
    };
    return EvmStream;
}());
