...
type OperationId$n = 'aptosStreamsAddAddresses';
type PathParams$f = operations[OperationId$n]['parameters']['path'];
type BodyParams$a = operations[OperationId$n]['requestBody']['content']['application/json'];
type RequestParams$l = PathParams$f & BodyParams$a;
type SuccessResponse$n = operations[OperationId$n]['responses']['200']['content']['application/json'];
interface AddAddressAptosRequest extends Camelize<Omit<RequestParams$l, 'address'>> {
    address: AptosAddressInput | AptosAddressInput[];
}
type AddAddressAptosJSONRequest = ReturnType<typeof serializeRequest$l>;
type AddAddressAptosJSONResponse = SuccessResponse$n;
type AddAddressAptosResponse = ReturnType<typeof deserializeResponse$n>;
...
declare function deserializeResponse$n(jsonResponse: AddAddressAptosJSONResponse): {
    address: AptosAddress | AptosAddress[] | undefined;
    streamId: string;
};
declare function serializeRequest$l(request: AddAddressAptosRequest): {
    id: string;
    address: string | string[];
};

type OperationId$m = 'aptosStreamsGetAll';
type QueryParams$4 = operations[OperationId$m]['parameters']['query'];
type RequestParams$k = QueryParams$4;
type SuccessResponse$m = operations[OperationId$m]['responses']['200']['content']['application/json'];
interface GetStreamsAptosRequest extends Camelize<RequestParams$k> {
}
type GetStreamsAptosJSONRequest = ReturnType<typeof serializeRequest$k>;
type GetStreamsAptosJSONResponse = SuccessResponse$m;
type GetStreamsAptosResponse = ReturnType<typeof deserializeResponse$m>;
...
declare function deserializeResponse$m(jsonResponse: GetStreamsAptosJSONResponse): AptosStream[];
declare function serializeRequest$k(request: GetStreamsAptosRequest): {
    cursor: string | undefined;
    limit: number;
};

type OperationId$l = 'aptosStreamsGet';
type PathParams$e = operations[OperationId$l]['parameters']['path'];
type RequestParams$j = PathParams$e;
type SuccessResponse$l = operations[OperationId$l]['responses']['200']['content']['application/json'];
interface GetStreamAptosRequest extends Camelize<RequestParams$j> {
}
type GetStreamAptosJSONRequest = ReturnType<typeof serializeRequest$j>;
type GetStreamAptosJSONResponse = SuccessResponse$l;
type GetStreamAptosResponse = ReturnType<typeof deserializeResponse$l>;
...
declare function deserializeResponse$l(jsonResponse: GetStreamAptosJSONResponse): AptosStream;
declare function serializeRequest$j(request: GetStreamAptosRequest): {
    id: string;
};

type OperationId$k = 'aptosStreamsCreate';
type BodyParams$9 = operations[OperationId$k]['requestBody']['content']['application/json'];
type RequestParams$i = BodyParams$9;
type SuccessResponse$k = operations[OperationId$k]['responses']['200']['content']['application/json'];
interface CreateStreamAptosRequest extends Camelize<Omit<RequestParams$i, 'network'>> {
    network: AptosNetworkInput[];
}
type CreateStreamAptosJSONRequest = ReturnType<typeof serializeRequest$i>;
type CreateStreamAptosJSONResponse = SuccessResponse$k;
type CreateStreamAptosResponse = ReturnType<typeof deserializeResponse$k>;
...
declare function deserializeResponse$k(jsonResponse: CreateStreamAptosJSONResponse): AptosStream;
declare function serializeRequest$i(request: CreateStreamAptosRequest): {
...
type OperationId$j = 'aptosStreamsDeleteAddresses';
type PathParams$d = operations[OperationId$j]['parameters']['path'];
type BodyParams$8 = operations[OperationId$j]['requestBody']['content']['application/json'];
type RequestParams$h = PathParams$d & BodyParams$8;
type SuccessResponse$j = operations[OperationId$j]['responses']['200']['content']['application/json'];
interface DeleteAddressAptosRequest extends Camelize<Omit<RequestParams$h, 'address'>> {
    address: AptosAddressInput | AptosAddressInput[];
}
type DeleteAddressAptosJSONRequest = ReturnType<typeof serializeRequest$h>;
type DeleteAddressAptosJSONResponse = SuccessResponse$j;
type DeleteAddressAptosResponse = ReturnType<typeof deserializeResponse$j>;
...
declare function deserializeResponse$j(jsonResponse: DeleteAddressAptosJSONResponse): {
    address: string & (string | undefined)[];
    streamId: string;
};
declare function serializeRequest$h(request: DeleteAddressAptosRequest): {
    id: string;
    address: string | string[];
};

type OperationId$i = 'aptosStreamsDelete';
type PathParams$c = operations[OperationId$i]['parameters']['path'];
type RequestParams$g = PathParams$c;
type SuccessResponse$i = operations[OperationId$i]['responses']['200']['content']['application/json'];
interface DeleteStreamAptosRequest extends Camelize<RequestParams$g> {
}
type DeleteStreamAptosJSONRequest = ReturnType<typeof serializeRequest$g>;
type DeleteStreamAptosJSONResponse = SuccessResponse$i;
type DeleteStreamAptosResponse = ReturnType<typeof deserializeResponse$i>;
...
declare function deserializeResponse$i(jsonResponse: DeleteStreamAptosJSONResponse): boolean;
declare function serializeRequest$g(request: DeleteStreamAptosRequest): {
    id: string;
};

type OperationId$h = 'aptosStreamsGetAddresses';
type PathParams$b = operations[OperationId$h]['parameters']['path'];
type QueryParams$3 = operations[OperationId$h]['parameters']['query'];
type RequestParams$f = PathParams$b & QueryParams$3;
type SuccessResponse$h = operations[OperationId$h]['responses']['200']['content']['application/json'];
interface GetAddressesAptosRequest extends Camelize<Omit<RequestParams$f, 'limit'>> {
    limit?: number;
}
type GetAddressesAptosJSONRequest = ReturnType<typeof serializeRequest$f>;
type GetAddressesAptosJSONResponse = SuccessResponse$h;
type GetAddressesAptosResponse = ReturnType<typeof deserializeResponse$h>;
...
declare function deserializeResponse$h(jsonResponse: GetAddressesAptosJSONResponse): {
    result: AptosAddress[];
    total: number;
};
declare function serializeRequest$f(request: GetAddressesAptosRequest): {
    id: string;
    limit: number | undefined;
    cursor: string | undefined;
};

type OperationId$g = 'aptosStreamsUpdate';
type PathParams$a = operations[OperationId$g]['parameters']['path'];
type BodyParams$7 = operations[OperationId$g]['requestBody']['content']['application/json'];
type RequestParams$e = PathParams$a & BodyParams$7;
type SuccessResponse$g = operations[OperationId$g]['responses']['200']['content']['application/json'];
interface UpdateStreamAptosRequest extends Camelize<Omit<RequestParams$e, 'network'>> {
    network: AptosNetworkInput[];
}
type UpdateStreamAptosJSONRequest = ReturnType<typeof serializeRequest$e>;
type UpdateStreamAptosJSONResponse = SuccessResponse$g;
type UpdateStreamAptosResponse = ReturnType<typeof deserializeResponse$g>;
...
declare function deserializeResponse$g(jsonResponse: UpdateStreamAptosJSONResponse): AptosStream;
declare function serializeRequest$e(request: UpdateStreamAptosRequest): {
    id: string;
    allAddresses: boolean | undefined;
    demo: boolean | undefined;
...
type OperationId$f = 'aptosStreamsUpdateStatus';
type PathParams$9 = operations[OperationId$f]['parameters']['path'];
type BodyParams$6 = operations[OperationId$f]['requestBody']['content']['application/json'];
type RequestParams$d = PathParams$9 & BodyParams$6;
type SuccessResponse$f = operations[OperationId$f]['responses']['200']['content']['application/json'];
interface UpdateStreamStatusAptosRequest extends Camelize<RequestParams$d> {
}
type UpdateStreamStatusAptosJSONRequest = ReturnType<typeof serializeRequest$d>;
type UpdateStreamStatusAptosJSONResponse = SuccessResponse$f;
type UpdateStreamStatusAptosResponse = ReturnType<typeof deserializeResponse$f>;
...
declare function deserializeResponse$f(jsonResponse: UpdateStreamStatusAptosJSONResponse): {
    status: "active" | "paused" | "error" | "terminated";
    statusMessage: string;
};
declare function serializeRequest$d(request: UpdateStreamStatusAptosRequest): {
    id: string;
    status: Camelize<"active" | "paused" | "error" | "terminated">;
};

type OperationId$e = 'AddAddressToStream';
type PathParams$8 = operations[OperationId$e]['parameters']['path'];
type BodyParams$5 = operations[OperationId$e]['requestBody']['content']['application/json'];
type RequestParams$c = PathParams$8 & BodyParams$5;
type SuccessResponse$e = operations[OperationId$e]['responses']['200']['content']['application/json'];
interface AddAddressEvmRequest extends Camelize<Omit<RequestParams$c, 'address'>> {
    address: EvmAddressish | EvmAddressish[];
}
type AddAddressEvmJSONRequest = ReturnType<typeof serializeRequest$c>;
type AddAddressEvmJSONResponse = SuccessResponse$e;
type AddAddressEvmResponse = ReturnType<typeof deserializeResponse$e>;
...
declare function deserializeResponse$e(jsonResponse: AddAddressEvmJSONResponse): {
    address: EvmAddress | EvmAddress[] | undefined;
    streamId: string;
};
declare function serializeRequest$c(request: AddAddressEvmRequest, core: Core$1): {
    id: string;
    address: string | string[];
};

type OperationId$d = 'GetStreams';
type QueryParams$2 = operations[OperationId$d]['parameters']['query'];
type RequestParams$b = QueryParams$2;
type SuccessResponse$d = operations[OperationId$d]['responses']['200']['content']['application/json'];
interface GetStreamsEvmRequest extends Camelize<RequestParams$b> {
}
type GetStreamsEvmJSONRequest = ReturnType<typeof serializeRequest$b>;
type GetStreamsEvmJSONResponse = SuccessResponse$d;
type GetStreamsEvmResponse = ReturnType<typeof deserializeResponse$d>;
...
declare function deserializeResponse$d(jsonResponse: GetStreamsEvmJSONResponse, request: GetStreamsEvmRequest, core: Core$1): EvmStream[];
declare function serializeRequest$b(request: GetStreamsEvmRequest): {
    cursor: string | undefined;
    limit: number;
};

type OperationId$c = 'GetStream';
type PathParams$7 = operations[OperationId$c]['parameters']['path'];
type RequestParams$a = PathParams$7;
type SuccessResponse$c = operations[OperationId$c]['responses']['200']['content']['application/json'];
interface GetStreamEvmRequest extends Camelize<RequestParams$a> {
}
type GetStreamEvmJSONRequest = ReturnType<typeof serializeRequest$a>;
type GetStreamEvmJSONResponse = SuccessResponse$c;
type GetStreamEvmResponse = ReturnType<typeof deserializeResponse$c>;
...
declare function deserializeResponse$c(jsonResponse: GetStreamEvmJSONResponse, request: GetStreamEvmRequest, core: Core$1): EvmStream;
declare function serializeRequest$a(request: GetStreamEvmRequest): {
    id: string;
};

type OperationId$b = 'CreateStream';
type BodyParams$4 = operations[OperationId$b]['requestBody']['content']['application/json'];
type RequestParams$9 = BodyParams$4;
type SuccessResponse$b = operations[OperationId$b]['responses']['200']['content']['application/json'];
interface CreateStreamEvmRequest extends Camelize<Omit<RequestParams$9, 'chainIds' | 'triggers'>> {
    chains: EvmChainish[];
    triggers?: StreamTriggerish[];
}
type CreateStreamEvmJSONRequest = ReturnType<typeof serializeRequest$9>;
type CreateStreamEvmJSONResponse = SuccessResponse$b;
type CreateStreamEvmResponse = ReturnType<typeof deserializeResponse$b>;
...
declare function deserializeResponse$b(jsonResponse: CreateStreamEvmJSONResponse, request: CreateStreamEvmRequest, core: Core$1): EvmStream;
declare function serializeRequest$9(request: CreateStreamEvmRequest, core: Core$1): {
    webhookUrl: string;
    description: string;
    tag: string;
...
type OperationId$a = 'DeleteAddressFromStream';
type PathParams$6 = operations[OperationId$a]['parameters']['path'];
type BodyParams$3 = operations[OperationId$a]['requestBody']['content']['application/json'];
type RequestParams$8 = PathParams$6 & BodyParams$3;
type SuccessResponse$a = operations[OperationId$a]['responses']['200']['content']['application/json'];
interface DeleteAddressEvmRequest extends Camelize<Omit<RequestParams$8, 'address'>> {
    address: EvmAddressish | EvmAddressish[];
}
type DeleteAddressEvmJSONRequest = ReturnType<typeof serializeRequest$8>;
type DeleteAddressEvmJSONResponse = SuccessResponse$a;
type DeleteAddressEvmResponse = ReturnType<typeof deserializeResponse$a>;
...
declare function deserializeResponse$a(jsonResponse: DeleteAddressEvmJSONResponse, request: DeleteAddressEvmRequest, core: Core$1): {
    streamId: string;
    address: EvmAddress | EvmAddress[] | undefined;
};
declare function serializeRequest$8(request: DeleteAddressEvmRequest, core: Core$1): {
    id: string;
    address: string | string[];
};

type OperationId$9 = 'DeleteStream';
type PathParams$5 = operations[OperationId$9]['parameters']['path'];
type RequestParams$7 = PathParams$5;
type SuccessResponse$9 = operations[OperationId$9]['responses']['200']['content']['application/json'];
interface DeleteStreamEvmRequest extends Camelize<RequestParams$7> {
}
type DeleteStreamEvmJSONRequest = ReturnType<typeof serializeRequest$7>;
type DeleteStreamEvmJSONResponse = SuccessResponse$9;
type DeleteStreamEvmResponse = ReturnType<typeof deserializeResponse$9>;
...
declare function deserializeResponse$9(jsonResponse: DeleteStreamEvmJSONResponse, request: DeleteStreamEvmRequest, core: Core$1): EvmStream;
declare function serializeRequest$7(request: DeleteStreamEvmRequest): {
    id: string;
};

type OperationId$8 = 'GetAddresses';
type PathParams$4 = operations[OperationId$8]['parameters']['path'];
type QueryParams$1 = operations[OperationId$8]['parameters']['query'];
type RequestParams$6 = PathParams$4 & QueryParams$1;
type SuccessResponse$8 = operations[OperationId$8]['responses']['200']['content']['application/json'];
interface GetAddressesEvmRequest extends Camelize<Omit<RequestParams$6, 'limit'>> {
    limit?: number;
}
type GetAddressesEvmJSONRequest = ReturnType<typeof serializeRequest$6>;
type GetAddressesEvmJSONResponse = SuccessResponse$8;
type GetAddressesEvmResponse = ReturnType<typeof deserializeResponse$8>;
...
declare function deserializeResponse$8(jsonResponse: GetAddressesEvmJSONResponse, request: GetAddressesEvmRequest, core: Core$1): {
    address: EvmAddress | undefined;
}[];
declare function serializeRequest$6(request: GetAddressesEvmRequest): {
    id: string;
    limit: number | undefined;
    cursor: string | undefined;
};

type OperationId$7 = 'UpdateStream';
type PathParams$3 = operations[OperationId$7]['parameters']['path'];
type BodyParams$2 = operations[OperationId$7]['requestBody']['content']['application/json'];
type RequestParams$5 = PathParams$3 & BodyParams$2;
type SuccessResponse$7 = operations[OperationId$7]['responses']['200']['content']['application/json'];
interface UpdateStreamEvmRequest extends Camelize<Omit<RequestParams$5, 'chainIds' | 'triggers'>> {
    chains?: EvmChainish[];
    triggers?: StreamTriggerish[];
}
type UpdateStreamEvmJSONRequest = ReturnType<typeof serializeRequest$5>;
type UpdateStreamEvmJSONResponse = SuccessResponse$7;
type UpdateStreamEvmResponse = ReturnType<typeof deserializeResponse$7>;
...
declare function deserializeResponse$7(jsonResponse: UpdateStreamEvmJSONResponse, request: UpdateStreamEvmRequest, core: Core$1): EvmStream;
declare function serializeRequest$5(request: UpdateStreamEvmRequest, core: Core$1): {
    id: string;
    webhookUrl: string | undefined;
    description: string | undefined;
    tag: string | undefined;
...
type OperationId$6 = 'UpdateStreamStatus';
type PathParams$2 = operations[OperationId$6]['parameters']['path'];
type BodyParams$1 = operations[OperationId$6]['requestBody']['content']['application/json'];
type RequestParams$4 = PathParams$2 & BodyParams$1;
type SuccessResponse$6 = operations[OperationId$6]['responses']['200']['content']['application/json'];
interface UpdateStreamStatusEvmRequest extends Camelize<RequestParams$4> {
}
type UpdateStreamStatusEvmJSONRequest = ReturnType<typeof serializeRequest$4>;
type UpdateStreamStatusEvmJSONResponse = SuccessResponse$6;
type UpdateStreamStatusEvmResponse = ReturnType<typeof deserializeResponse$6>;
...
declare function deserializeResponse$6(jsonResponse: UpdateStreamStatusEvmJSONResponse): {
    webhookUrl: string;
    description: string;
    tag: string;
    topic0?: string[] | null | undefined;
...
declare function serializeRequest$4(request: UpdateStreamStatusEvmRequest): {
    id: string;
    status: Camelize<"active" | "paused" | "error" | "terminated">;
};

type OperationId$5 = 'GetHistory';
type QueryParams = operations[OperationId$5]['parameters']['query'];
type RequestParams$3 = QueryParams;
type SuccessResponse$5 = operations[OperationId$5]['responses']['200']['content']['application/json'];
interface GetHistoryRequest extends Camelize<RequestParams$3> {
}
type GetHistoryJSONRequest = ReturnType<typeof serializeRequest$3>;
type GetHistoryJSONResponse = SuccessResponse$5;
type GetHistoryResponse = ReturnType<typeof deserializeResponse$5>;
...
declare function deserializeResponse$5(jsonResponse: GetHistoryJSONResponse): {
    id: string;
    date: string;
    payload?: (Partial<{
        block: {
...
declare function serializeRequest$3(request: GetHistoryRequest): GetHistoryRequest;

type OperationId$4 = 'ReplayHistory';
type PathParams$1 = operations[OperationId$4]['parameters']['path'];
type RequestParams$2 = PathParams$1;
type SuccessResponse$4 = operations[OperationId$4]['responses']['200']['content']['application/json'];
interface ReplayHistoryRequest extends Camelize<RequestParams$2> {
}
type ReplayHistoryJSONRequest = ReturnType<typeof serializeRequest$2>;
type ReplayHistoryJSONResponse = SuccessResponse$4;
type ReplayHistoryResponse = ReturnType<typeof deserializeResponse$4>;
...
declare function deserializeResponse$4(jsonResponse: ReplayHistoryJSONResponse): {
    id: string;
    date: string;
    payload?: (Partial<{
        block: {
...
declare function serializeRequest$2(request: ReplayHistoryRequest): {
    streamId: string;
    id: string;
};
